...
namespace ServerModGenerator
{
    public class WeaponCollections
    {
        ...
        private Dictionary<string, string> WeaponNameToCodeConverter = new Dictionary<string, string>();
        private Dictionary<string, string> WeaponCodeToNameConverter = new Dictionary<string, string>();
